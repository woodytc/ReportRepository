Ext.define('Report.view.report.List', {
    ...
    initComponent: function () {
        ...
        this.columns = [
            ...
            /* [20131021] Narin K.
             *  - Display all problem mode 
             *  - request by P'Nu via email [Fix bug - Mon 10/21/2013 9:17 AM]                
             */
            { dataIndex: 'UnpluggedState', text: 'Unplugged', width: 80, sortable: true, renderer:onRenderer },
            { dataIndex: 'PowerLossState', text: 'Power Loss', width: 80, sortable: true, renderer:onRenderer },
            { dataIndex: 'MissingGpsState', text: 'Missing GPS', width: 80, sortable: true, renderer:onRenderer },
