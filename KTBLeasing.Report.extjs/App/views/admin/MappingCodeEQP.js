Ext.define('MappingCodeEQPForm', {
     extend: 'Ext.Panel',
    constructor: function (config) {
        var me = this;
        var prefix = "MappingCodeEQPForm-";
        me.prefix = prefix;
        ...
        me.gridStore = Ext.create('Ext.data.JsonStore', {
            ...
            pageSize: 25,
            model: 'MasterMappingCodeEQPModel',
            proxy: proxyOptions
        });
        ...
        Ext.apply(this, {
            ...
            items: [
                    {
                        ...
                        items: [
                                {   // column 1
                                    ...
                                    items: [
                                            { id: me.prefix + 'Name', name: 'Name', fieldLabel: 'ประเภททรัพย์สิน', labelStyle: 'text-align: right', emptyText: '[ชื่อประเภททรัพย์สิน]', anchor: '-600' }
                                    ]
                                }
            ...
            { text: 'ชื่อประเภททรัพย์สิน', dataIndex: 'Name', width: 250, sortable: false, align: 'center'}//,
        ...
        //me.gridStore.setpro
        MappingCodeEQPForm.superclass.constructor.apply(this, arguments);
    } // end constructor
});

//fn update
MappingCodeEQPForm.prototype.popUpEditItem = function (dataview, record, parent, mode) {
    var id = record.get('Id');
    var name = record.get("Name");
    MappingCodeEQPForm.prototype.popUpEditColor(id, name);
};

//fn search
MappingCodeEQPForm.prototype.search = function (url, name) {
    var prefix = 'MappingCodeEQPForm-';
...
MappingCodeEQPForm.prototype.popUpEditColor = function (id, name) {
            ...
            onClick: function (button) {
                ...
                Ext.Ajax.request({
                    ...
                    success: function (response) {
                        ...
                        MappingCodeEQPForm.prototype.search(window.gridColorData, "");
                    }
                });
...
//delete Color
MappingCodeEQPForm.prototype.deleteColor = function (dataview, reconds, type) {
    var ColorIds = [];
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.success) {
                ...
                MappingCodeEQPForm.prototype.search(me.url,"");
            }
            else {
