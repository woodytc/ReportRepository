Ext.define('EditManageReportWindow', {
    extend: 'Ext.Window',
    initComponent: function () {
        ...
        var ReportManage = {
            ...
            items: [
                { id: me.prefix + 'Reportname', name: 'Reportname', fieldLabel: 'ชื่อรายงาน', afterLabelTextTpl: required, labelStyle: 'text-align: right'
                    , xtype: 'textfield', fieldStyle: 'text-align: right', allowBlank: false, emptyText: '[ชื่อรายงาน]'
                },
                { id: me.prefix + 'Reportfilename', name: 'Reportfilename', fieldLabel: 'ชื่อไฟล์รายงาน', afterLabelTextTpl: required, labelStyle: 'text-align: right'
                    , xtype: 'textfield', fieldStyle: 'text-align: right', allowBlank: false, emptyText: '[ชื่อไฟล์รายงาน]'
                },
                { id: me.prefix + 'Path', name: 'Path', fieldLabel: 'Folder', afterLabelTextTpl: required, labelStyle: 'text-align: right'
                    , xtype: 'textfield', fieldStyle: 'text-align: right', allowBlank: false, emptyText: '[Folder]'
                }
            ]
        };
        ...
        Ext.apply(me, {
            ...
            title: 'New Report',
            y: 20,
            //y: ((Ext.getBody().getViewSize())/2)-70,
           // x: (Ext.getBody().getViewSize().height)/2,
            //resizable: false,
            modal: true,
            buttonAlign: 'center',
            //            autoScroll: true,
        ...
        EditManageReportWindow.superclass.initComponent.apply(me, arguments);
    } // end initComponent
}); // end Ext.define('EditManageReportWindow


EditManageReportWindow.prototype.create = function () {
...
EditManageReportWindow.prototype.isValid = function () {
    console.log('isValid');
    var prefix = this.prefix;
...
EditManageReportWindow.prototype.editUserAndRoles = function (id, username, email, role, parent) {
...
EditManageReportWindow.prototype.prepareData = function () {
